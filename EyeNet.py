...
class EyeTrackNet_seq(nn.Module):
    def __init__(self, input_size=4, hidden_size=128, output_size=2, num_layers=4, dropout = 0.2):
        ...
        self.output_layer = nn.Sequential(nn.Linear(hidden_size, hidden_size),
                                          nn.ReLU(),
                                          nn.Dropout(dropout),
...
class EyeTrackNet_MLP(nn.Module):
    def __init__(self, input_channel=4, input_seq_len=50, output_size=2):
